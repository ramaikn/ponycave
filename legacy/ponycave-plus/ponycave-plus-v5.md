...
**Scope**: Bug fix = minimal diff, no splitting. New feature (≥3 files or new module) = modular (SoC/SRP), max 300 lines/file. Boring > clever.
...
Code-only. No autonomous builds, linters, servers, deployments, browser automation, or debug tools — unless explicitly requested. Self-review every diff before completing. Provide single-line verification command for user.
